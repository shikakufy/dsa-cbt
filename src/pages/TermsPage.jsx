  ...
  return (
    <div className="top-page-root">
      ...
      <main className="container" style={{ padding: '120px 40px 60px', textAlign: 'left' }}>
        <h1 style={{ fontSize: '2rem', marginBottom: '2rem', color: '#2A2118', textAlign: 'left' }}>利用規約</h1>
        <div style={{ color: '#5b4e3e', lineHeight: '1.9', fontSize: '0.95rem', maxWidth: '900px' }}>
          ...
          <h3 style={{ fontSize: '1.1rem', color: '#2A2118', marginTop: '2rem', marginBottom: '0.8rem', fontWeight: '700' }}>第1条（適用）</h3>
          <p style={{ marginBottom: '1.5rem' }}>本規約は，ユーザーと当社との間の本サービスの利用に関わる一切の関係に適用されるものとします。</p>

          <h3 style={{ fontSize: '1.1rem', color: '#2A2118', marginTop: '2rem', marginBottom: '0.8rem', fontWeight: '700' }}>第2条（利用登録・アカウント管理）</h3>
          ...
          <h3 style={{ fontSize: '1.1rem', color: '#2A2118', marginTop: '2rem', marginBottom: '0.8rem', fontWeight: '700' }}>第3条（知的財産権）</h3>
          ...
          <h3 style={{ fontSize: '1.1rem', color: '#2A2118', marginTop: '2rem', marginBottom: '0.8rem', fontWeight: '700' }}>第4条（禁止事項）</h3>
          ...
          <h3 style={{ fontSize: '1.1rem', color: '#2A2118', marginTop: '2rem', marginBottom: '0.8rem', fontWeight: '700' }}>第5条（本サービスの提供の停止等）</h3>
          ...
          <h3 style={{ fontSize: '1.1rem', color: '#2A2118', marginTop: '2rem', marginBottom: '0.8rem', fontWeight: '700' }}>第6条（保証の否認および免責事項）</h3>
          ...
          <h3 style={{ fontSize: '1.1rem', color: '#2A2118', marginTop: '2rem', marginBottom: '0.8rem', fontWeight: '700' }}>第7条（サービス内容の変更等）</h3>
          <p style={{ marginBottom: '1.5rem' }}>当社は，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。</p>

          <h3 style={{ fontSize: '1.1rem', color: '#2A2118', marginTop: '2rem', marginBottom: '0.8rem', fontWeight: '700' }}>第8条（準拠法・裁判管轄）</h3>
          ...
          <p style={{ marginTop: '3rem', fontSize: '0.9rem', color: '#5b4e3e', borderTop: '1px solid #e9e0c8', paddingTop: '1.5rem' }}>令和8年3月2日 制定<br />デジタルスキルアカデミー合同会社</p>
        </div>
      </main>
